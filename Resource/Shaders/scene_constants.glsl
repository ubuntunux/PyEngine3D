...
layout(std140, binding=6) uniform emitter_infos
{
    ...
    bool EMITTER_ENABLE_VECTOR_FIELD;
    vec3 EMITTER_VELOCITY_POSITION_MAX;
    float EMITTER_VECTOR_FIELD_STRENGTH;
    vec3 EMITTER_VELOCITY_ROTATION_MIN;
    float EMITTER_VECTOR_FIELD_TIGHTNESS;
    ...
    mat4 EMITTER_VECTOR_FIELD_MATRIX;
    mat4 EMITTER_VECTOR_FIELD_INV_MATRIX;
};
