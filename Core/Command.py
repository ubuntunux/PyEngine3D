...
CMD_SEND_PRIMITIVENAME  = cmd_index.send("CMD_SEND_PRIMITIVENAME")
CMD_REQUEST_PRIMITIVEINFOS = cmd_index.send("CMD_REQUEST_PRIMITIVEINFOS")
CMD_SEND_PRIMITIVEINFOS = cmd_index.send("CMD_SEND_PRIMITIVEINFOS")
CMD_SET_PRIMITIVEINFO = cmd_index.send("CMD_SET_PRIMITIVEINFO")

CMD_OBJECT_MOVE = cmd_index.send("CMD_OBJECT_MOVE")
