...
class ResourceLoader(object):
    ...
    def __init__(self, resource_manager, root_path):
        self.resource_manager = resource_manager
...
class MaterialLoader(ResourceLoader):
    ...
    def __init__(self, resource_manager, root_path):
        ResourceLoader.__init__(self, resource_manager, root_path)
...
class ResourceManager(Singleton):
    ...
    PathResources = os.path.split(__file__)[0]
    ...
    def regist_loader(self, resource_loader_class):
        resource_loader = resource_loader_class(self, self.root_path)
